...
static const uint32_t crc32_table[256] = {
    ...
    0xD6D6A3E8U, 0xA1D1937EU, 0x38D8C2C4U, 0x4FD8B252U,
    ...
    0xAED16A4AU, 0xD9D65ADCU, 0x40BF0B66U, 0x37B83BF0U,
...
void proto_parser_init(ProtoParser_t *p) {
    ...
    p->payload_idx = 0;
    p->rx_crc      = 0;
    /* Keep an unfinalized IEEE CRC accumulator; frame output is finalized. */
